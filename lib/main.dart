...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      appBar: AppBar(
        title: const Text(
          ...
          style: TextStyle(
            ...
            color: Color.fromARGB(255, 220, 192, 255)
          ),
        ),
    ...
    body: Container(
        color: Color.fromARGB(255, 0, 0, 0), // Set the background color of the whole page
        child: Center(
          child: Column(
            ...
            children: [
              const Text(
                ...
                style: TextStyle(
                  fontSize: 36.0,
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(255, 57, 0, 128),
                ),
              ),
      ...
      itemBuilder: (context, index) {
        ...
        return Column(
          children: [
            ...
            const SizedBox(height: 15), // Adjust the height according to your spacing preference
          ],
        );
      },
    ),
